...
\coordinate (l4)     at ($(hvfeval)!0.5!(neukineval)$);
\coordinate (l5)     at ($(neukineval)!0.5!(kin)$);
\coordinate (l6)     at ($(kin)!0.5!(atm)$);
...
\draw (atmmix) -- (moldiff);
\draw (temp) -- (moldiff);
\draw (alt) ..controls ([yshift=-20pt]temp.south east) .. (moldiff);
\draw (atmmix) ..controls(moldiff.north west).. (eddy);
\draw (alt) ..controls ([yshift=-10pt]ionreac.south east) and (bindiff.south east).. (eddy);
\draw (atmmix) -- (diff);
\draw (temp) -- (diff);
\draw (alt) -- (diff);
\draw[dashed] (hvfeval) ..controls([yshift=1cm]ionkineval.north).. (neukineval);
\draw[dashed] (hvfeval) -- (ionkineval);
